    ...
    return (
        <View>
            <View style={style.header}>
                ...
                <Text style={style.headerText}>{strings('OTPModal.VerificationCodePrompt')}</Text>
            </View>
            <Text style={style.buttonText}>{strings('OTPModal.SentCodePrompt')} {this.props.buttonText}</Text>
            <TouchableOpacity style={styles.resendBtnWrap} onPress={this.props.resend}>
                <Text style={style.resendBtn}>{strings('OTPModal.ResendOTP')}</Text>
            </TouchableOpacity>
        </View>
    );
}
